<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="analista.aspx.cs" Inherits="Login_InfoToolsSV.AnalistaPage" %>
...
<head runat="server">
    ...
    <title>Portal del Analista</title>
...
<body>
    <div class="container-form">
        <form id="formulario_analista" runat="server">
            ...
            <!-- Sección para análisis personalizados -->
            <div class="mdx-container">
                <h4>Análisis Personalizados</h4>
                <asp:TextBox ID="txtAnalisis" runat="server" CssClass="form-control" TextMode="MultiLine" Rows="5" Placeholder="Ingrese su análisis aquí..."></asp:TextBox>
                <asp:Button ID="BtnGenerarReporte" runat="server" Text="Generar Reporte" CssClass="btn btn-primary custom-btn" OnClick="BtnGenerarReporte_Click" />

                <!-- Resultado del reporte -->
                <div class="result-box">
                    <asp:Label ID="lblResultadoReporte" runat="server" Text="Resultado del reporte:" CssClass="form-label"></asp:Label>
                    <asp:Literal ID="ltResultadoReporte" runat="server"></asp:Literal>
                </div>
            </div>
